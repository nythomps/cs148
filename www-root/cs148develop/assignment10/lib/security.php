...
function securityCheck($path_parts, $yourURL, $form = false) {
    ...
    $whiteListPages[] = "poetAddCode.php";
    $whiteListPages[] = "poetCode.php";
    $whiteListPages[] = "poetSortCode.php";
    ...
    $whiteListPages[] = "approved.php";
    $whiteListPages[] = "blog1.php";
    $whiteListPages[] = "blog2.php";
