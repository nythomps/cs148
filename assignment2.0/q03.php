...
if ($tableName != "") {
    ...
    $query = 'SHOW COLUMNS FROM q03_COLUMNS';
    ...
    $query = "SELECT fldSection FROM tblSections WHERE fldStart = '13:10:00' AND fldBuilding = 'KALKIN'";  
    $a = $thisDatabaseReader->select($query,  "", 1, 1, 4, 0, false, false);
