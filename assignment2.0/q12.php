...
if ($tableName != "") {
    ...
    $query = 'SHOW COLUMNS FROM q12_COLUMNS';
    ...
    $query = 'SELECT tblSections.fldMaxStudents, tblSections.fldNumStudents, tblSections.fldSection, tblSections.fldNumStudents-tblSections.fldMaxStudents AS TotalNumStudentsOverCapacity FROM tblSections WHERE tblSections.fldNumStudents > tblSections.fldMaxStudents';
    $a = $thisDatabaseReader->select($query,  "", 1, 0, 0, 1, false, false);
