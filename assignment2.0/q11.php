...
if ($tableName != "") {
    ...
    $query = 'SHOW COLUMNS FROM q11_COLUMNS';
    ...
    $query = "SELECT tblSections.fnkCourseId , COUNT(tblSections.fldSection) FROM tblSections GROUP BY fnkCourseId HAVING COUNT(tblSections.fldSection) > 49";
    $a = $thisDatabaseReader->select($query,  "", 0, 0, 0, 1, false, false);
