...
if ($tableName != "") {
    ...
    $query = 'SHOW COLUMNS FROM q09_COLUMNS';
    ...
    $query = "SELECT tblSections.fldBuilding,COUNT(tblSections.fldNumStudents) AS NumberofStudentsonWednesday FROM tblSections WHERE fldDays LIKE '%__W__%' GROUP BY fldBuilding ORDER BY NumberofStudentsonWednesday DESC";
    $a = $thisDatabaseReader->select($query,  "", 1, 1, 2, 0, false, false);
