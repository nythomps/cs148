...
if ($tableName != "") {
    ...
    $query = 'SHOW COLUMNS FROM q07_COLUMNS';
    ...
    $query = "SELECT fldDepartment FROM tblCourses WHERE fldCourseName LIKE '$value_s%'";  
    $a = $thisDatabaseReader->select($query,  "", 1, 0, 2, 0, false, false);
