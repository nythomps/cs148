...
if ($tableName != "") {
    ...
    $query = 'SHOW COLUMNS FROM q05_COLUMNS';
    ...
    $query = "SELECT fldLastName, fldFirstName FROM tblTeachers WHERE pmkNetId LIKE 'r%' AND pmkNetId like '%______o%' AND fldLastName NOT LIKE 'P%'";  
    $a = $thisDatabaseReader->select($query,  "", 1, 3, 6, 0, false, false);
