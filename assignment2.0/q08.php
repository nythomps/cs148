...
if ($tableName != "") {
    ...
    $query = 'SHOW COLUMNS FROM q08_COLUMNS';
    ...
    $query = 'SELECT tblSections.fldBuilding,COUNT(tblSections.fldSection) AS NumberofSections FROM tblSections GROUP BY fldBuilding';
